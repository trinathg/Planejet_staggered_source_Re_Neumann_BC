...
void compute_pbc(fval * fvar, pbcs& pbc, int up)
{
	  ...
	  tdma1y(fvar,0);  //Evaluate du/dy at all points in the domain
	  ...
	  { 
	  	...
	  	for(int j=0;j<=ny;j++) //Getting the pressure gradient at the left and right faces of the domain 
	  	{
	     		...
	     		//pbc.p2x[j] = (1./Re)*( fvar[ind2].uxx[0] + fvar[ind2].uyy[0] ) - fvar[ind2].u[1]*fvar[ind2].uy[0]-fvar[ind2].dudt;      //Right boundary

			pbc.p2x[j] = (1./Re)*(fvar[ind2].uyy[0]) - (1./Re)*(fvar[ind2].ux[5]) ;
